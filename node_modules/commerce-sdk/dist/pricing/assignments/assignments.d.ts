...
export declare namespace Assignments {
    ...
    export type PromotionCampaignAssignmentSearchResult = {
...
Note that only searchable attributes can be used in sorting.
    ...
    *
    */
    assignmentsSearch<T extends boolean>(options: {
        parameters?: {
            organizationId?: string;
            siteId?: string;
        };
        ...
        body: Assignments.SearchRequest;
    }, rawResponse?: T): Promise<T extends true ? Response : Assignments.PromotionCampaignAssignmentSearchResult>;
}
